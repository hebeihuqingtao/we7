<div class="container-fluid">
    ...
    <div class="portlet box green" style="margin-top: 10px">
        ...
        <div class="portlet-body form">
            ...
            <form action="index.php?r=index/updateok" id="form_sample_2" class="form-horizontal" method="post">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <span class="span6 m-wrap"><h4><?=$info['w_name']?></h4></span>

                        <input type="hidden" name="w_name" data-required="1" class="span6 m-wrap" value="<?=$info['w_name']?>"/>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <input name="w_appid" type="text" class="span6 m-wrap" value="<?=$info['w_appid']?>"/>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <input name="w_serveid" type="text" class="span6 m-wrap" value="<?=$info['w_serveid']?>"/>
